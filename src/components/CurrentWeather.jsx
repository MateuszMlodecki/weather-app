...
const CurrentWeather = ({ location, weatherData }) => {
  ...
  return (
    <Box>
      ...
      <Typography>Temperatura odczuwalna: {weatherData.main.feels_like} °C</Typography>
      <Typography>Wilgotność: {weatherData.main.humidity}%</Typography>
      <Typography>Wiatr: {weatherData.wind.speed} m/s</Typography>
      <Stack direction="row" justifyContent="center" alignItems="center" style={{ fontSize: "48px" }}>
        {weatherIcon}
      </Stack>
    </Box>
  );
